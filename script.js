...
const translations = {
    tr: {
        ...
        'about-subtitle': '30 yılı aşkın deneyimimizle kalıp üretiminde öncü firma',
        'about-hero-title': 'Hakkımızda',
        'about-hero-subtitle': '30 yılı aşkın deneyimimizle kalıp üretiminde öncü firma',
        'story-title': 'Hikayemiz',
        'about-story-1': 'Aymold, enjeksiyon kalıp imalatında 25 yılı aşkın tecrübesi, güçlü teknik altyapısı ve uzman kadrosuyla sektöre yön veren firmalardan biridir.',
        'about-story-2': 'Müşterilerimizin ihtiyaçlarını sadece kalıp üretimiyle sınırlı görmüyoruz; projeye ürün tasarımı aşamasından itibaren dahil oluyor, fikirden üretime kadar tüm süreçte çözüm ortağı olarak yer alıyoruz.',
        'about-story-3': 'Modern CAD/CAM sistemleri, 3D modelleme ve mühendislik destekli analizlerle ürünlerin hem fonksiyonel hem de üretilebilir olmasını sağlıyoruz. Ardından kalıp tasarımı sürecinde, dayanıklılık, üretim hızı ve maliyet optimizasyonunu dikkate alarak en verimli çözümleri sunuyoruz.',
        'about-story-4': 'Geniş ve sürekli yenilenen makine parkurumuz, yüksek hassasiyetli CNC işleme merkezlerimiz ve deneyimli operatör kadromuz ile kalıp üretim sürecini kalite standartlarından ödün vermeden gerçekleştiriyoruz. Her bir proje, titizlikle yönetilen kalite kontrol süreçlerinden geçerek müşterilerimize eksiksiz şekilde teslim ediliyor.',
        'about-story-5': 'Aymold olarak biz, sadece kalıp üretmiyoruz; markaların ürünlerini hayata geçiriyor, onların rekabet gücünü artıracak teknik çözümler sunuyoruz.',
        'about-story-6': 'Ürün fikrinden seri üretime uzanan yolculukta yanınızdayız.',
        'about-story-7': 'Aymold –yüksek hassasiyetli enjeksiyon kalıp imalatında güvenilir çözüm ortağınız.',
        'about-mission-title': 'Misyonumuz',
        'about-mission-text': 'Müşterilerimizin ihtiyaçlarını en iyi şekilde anlayarak, yüksek kaliteli ve özel tasarım kalıplar üretmek. Sektörde güvenilir ve yenilikçi çözümler sunarak, müşteri memnuniyetini en üst seviyede tutmak.',
        'about-vision-title': 'Vizyonumuz',
        'about-vision-text': 'Türkiye\'nin önde gelen kalıp üretim firması olmak ve uluslararası pazarlarda söz sahibi olmak. Teknolojik gelişmeleri takip ederek, sektörde öncü rol üstlenmek.',
        'about-values-title': 'Değerlerimiz',
        'about-values-subtitle': 'Çalışma prensiplerimizi oluşturan temel değerler',
        'about-value-quality-title': 'Kalite',
        'about-value-quality-text': 'Her projede en yüksek kalite standartlarını sağlamak için çalışıyoruz.',
        'about-value-reliability-title': 'Güvenilirlik',
        'about-value-reliability-text': 'Müşterilerimizle uzun vadeli, güvenilir iş ortaklıkları kuruyoruz.',
        'about-value-innovation-title': 'Yenilikçilik',
        'about-value-innovation-text': 'Sürekli gelişim ve yenilikçi çözümler üretmeye odaklanıyoruz.',
        'about-value-delivery-title': 'Zamanında Teslimat',
        'about-value-delivery-text': 'Projelerimizi belirlenen sürelerde tamamlamaya özen gösteriyoruz.',
        'about-cta-title': 'Bizimle Çalışmaya Hazır mısınız?',
        'about-cta-subtitle': 'Projeleriniz için profesyonel kalıp çözümleri sunuyoruz. Hemen iletişime geçin!',
        'about-cta-button-1': 'Teklif Alın',
        'about-cta-button-2': 'İletişime Geçin',
        ...
        'services-hero-subtitle': 'Kalıp üretimi ve CNC işleme çözümleri',
        'services-main-title': 'HİZMETLERİMİZ',
        'service-mold-design-title': 'Kalıp Tasarımı',
        'service-mold-design-desc': 'Profesyonel kalıp tasarım hizmetleri ile üretim süreçlerinizi optimize edin.',
        'service-mold-production-title': 'Kalıp Üretimi',
        'service-mold-production-desc': 'Yüksek kaliteli kalıp üretimi ile seri üretim kapasitenizi artırın.',
        'service-cnc-machining-title': 'CNC Fason İşleme',
        'service-cnc-machining-desc': 'Hassas CNC işleme ile karmaşık parça üretimi gerçekleştirin.',
        'service-wire-erosion-title': 'Tel Erezyon Fason Üretim',
        'service-wire-erosion-desc': 'Tel erezyon teknolojisi ile hassas kesim ve şekillendirme işlemleri.',
        'service-product-design-title': 'Ürün Tasarımı',
        'service-product-design-desc': 'Yenilikçi ürün tasarımı ile pazarda öne çıkın.',
        'services-industries-title': 'Hizmet Verdiğimiz Sektörler',
        'services-industries-subtitle': 'Farklı sektörlerde uzmanlaşmış çözümler',
        'industry-white-goods-title': 'Beyaz Eşya',
        'industry-white-goods-desc': 'Buzdolabı, çamaşır makinesi, bulaşık makinesi gibi beyaz eşyalar için hassas kalıp üretimi.',
        'industry-electrical-electronics-title': 'Elektrik Elektronik',
        'industry-electrical-electronics-desc': 'Elektrik ve elektronik cihazlar için özel kalıp tasarımları ve üretimi.',
    ...
    ru: {
        ...
        'services-hero-subtitle': 'Производство пресс-форм и решения с ЧПУ',
        'services-main-title': 'НАШИ УСЛУГИ',
        'service-mold-design-title': 'Проектирование Пресс-форм',
        'service-mold-design-desc': 'Оптимизируйте ваши производственные процессы с профессиональными услугами по проектированию пресс-форм.',
        'service-mold-production-title': 'Производство Пресс-форм',
        'service-mold-production-desc': 'Увеличьте вашу мощность серийного производства с высококачественным производством пресс-форм.',
        'service-cnc-machining-title': 'ЧПУ Аутсорсинг',
        'service-cnc-machining-desc': 'Достигайте производства сложных деталей с точной обработкой ЧПУ.',
        'service-wire-erosion-title': 'Проволочная Эрозия Аутсорсинг',
        'service-wire-erosion-desc': 'Точные операции резки и формообразования с технологией проволочной эрозии.',
        'service-product-design-title': 'Проектирование Продукта',
        'service-product-design-desc': 'Выделяйтесь на рынке с инновационным проектированием продукта.',
        'services-industries-title': 'Секторы, в которых мы работаем',
        'services-industries-subtitle': 'Специализированные решения в разных секторах',
        ...
        // About Page
        'about-title': 'О нас',
        'about-subtitle': 'Ведущая компания в производстве пресс-форм с более чем 30-летним опытом',
        'about-hero-title': 'О нас',
        'about-hero-subtitle': 'Ведущая компания в производстве пресс-форм с более чем 30-летним опытом',
        'story-title': 'Наша История',
        'about-story-1': 'Aymold - одна из компаний, ведущих сектор в производстве пресс-форм для литья под давлением с более чем 25-летним опытом, сильной технической инфраструктурой и экспертной командой.',
        'about-story-2': 'Мы не рассматриваем потребности наших клиентов ограниченными только производством пресс-форм; мы участвуем в проекте с этапа проектирования продукта, действуя как партнер-решение на протяжении всего процесса от идеи до производства.',
        'about-story-3': 'С современными системами CAD/CAM, 3D-моделированием и инженерно-поддерживаемым анализом мы обеспечиваем, чтобы продукты были как функциональными, так и производимыми. Затем в процессе проектирования пресс-форм мы предлагаем наиболее эффективные решения, учитывая долговечность, скорость производства и оптимизацию затрат.',
        'about-story-4': 'С нашим обширным и постоянно обновляемым парком станков, высокоточными центрами обработки с ЧПУ и опытным персоналом операторов мы осуществляем процесс производства пресс-форм без компромиссов в стандартах качества. Каждый проект проходит через тщательно управляемые процессы контроля качества и доставляется нашим клиентам полностью.',
        'about-story-5': 'Как Aymold, мы не просто производим пресс-формы; мы воплощаем в жизнь продукты брендов, предлагая технические решения, которые увеличат их конкурентную силу.',
        'about-story-6': 'Мы с вами на пути от идеи продукта до массового производства.',
        'about-story-7': 'Aymold – ваш надежный партнер-решение в высокоточном производстве пресс-форм для литья под давлением.',
        'about-mission-title': 'Наша Миссия',
        'about-mission-text': 'Понимать потребности наших клиентов наилучшим образом и производить высококачественные и индивидуально спроектированные пресс-формы. Предоставлять надежные и инновационные решения в секторе, поддерживая удовлетворенность клиентов на самом высоком уровне.',
        'about-vision-title': 'Наше Видение',
        'about-vision-text': 'Стать ведущей компанией по производству пресс-форм в Турции и иметь право голоса на международных рынках. Взять на себя ведущую роль в секторе, следуя технологическим разработкам.',
        'about-values-title': 'Наши Ценности',
        'about-values-subtitle': 'Основные ценности, формирующие наши рабочие принципы',
        'about-value-quality-title': 'Качество',
        'about-value-quality-text': 'Мы работаем, чтобы обеспечить самые высокие стандарты качества в каждом проекте.',
        'about-value-reliability-title': 'Надежность',
        'about-value-reliability-text': 'Мы устанавливаем долгосрочные, надежные деловые партнерства с нашими клиентами.',
        'about-value-innovation-title': 'Инновации',
        'about-value-innovation-text': 'Мы сосредоточены на постоянном улучшении и производстве инновационных решений.',
        'about-value-delivery-title': 'Своевременная Доставка',
        'about-value-delivery-text': 'Мы уделяем внимание завершению наших проектов в установленные сроки.',
        'about-cta-title': 'Готовы Работать с Нами?',
        'about-cta-subtitle': 'Мы предлагаем профессиональные решения для пресс-форм для ваших проектов. Свяжитесь с нами сейчас!',
        'about-cta-button-1': 'Получить Предложение',
        'about-cta-button-2': 'Связаться с Нами',
    ...
    en: {
        ...
        'services-hero-subtitle': 'Mold manufacturing and CNC processing solutions',
        'services-main-title': 'OUR SERVICES',
        'service-mold-design-title': 'Mold Design',
        'service-mold-design-desc': 'Optimize your production processes with professional mold design services.',
        'service-mold-production-title': 'Mold Production',
        'service-mold-production-desc': 'Increase your mass production capacity with high-quality mold production.',
        'service-cnc-machining-title': 'CNC Outsourcing',
        'service-cnc-machining-desc': 'Achieve complex part production with precise CNC processing.',
        'service-wire-erosion-title': 'Wire Erosion Outsourcing',
        'service-wire-erosion-desc': 'Precise cutting and shaping operations with wire erosion technology.',
        'service-product-design-title': 'Product Design',
        'service-product-design-desc': 'Stand out in the market with innovative product design.',
        'services-industries-title': 'Industries We Serve',
        'services-industries-subtitle': 'Specialized solutions in different sectors',
        ...
        'about-subtitle': 'Leading mold manufacturing company with over 30 years of experience',
        'about-hero-title': 'About Us',
        'about-hero-subtitle': 'Leading mold manufacturing company with over 30 years of experience',
        'story-title': 'Our Story',
        'about-story-1': 'Aymold is one of the companies leading the sector in injection mold manufacturing with over 25 years of experience, strong technical infrastructure and expert staff.',
        'about-story-2': 'We do not see our customers\' needs limited to mold production only; we get involved in the project from the product design stage, acting as a solution partner throughout the entire process from idea to production.',
        'about-story-3': 'With modern CAD/CAM systems, 3D modeling and engineering-supported analyses, we ensure that products are both functional and manufacturable. Then in the mold design process, we offer the most efficient solutions by considering durability, production speed and cost optimization.',
        'about-story-4': 'With our extensive and continuously renewed machine park, high-precision CNC machining centers and experienced operator staff, we carry out the mold production process without compromising quality standards. Each project goes through meticulously managed quality control processes and is delivered to our customers completely.',
        'about-story-5': 'As Aymold, we do not just produce molds; we bring brands\' products to life, offering technical solutions that will increase their competitive power.',
        'about-story-6': 'We are with you on the journey from product idea to mass production.',
        'about-story-7': 'Aymold – your reliable solution partner in high-precision injection mold manufacturing.',
        'about-mission-title': 'Our Mission',
        'about-mission-text': 'To understand our customers\' needs in the best way possible and produce high-quality and custom-designed molds. To provide reliable and innovative solutions in the sector while maintaining customer satisfaction at the highest level.',
        'about-vision-title': 'Our Vision',
        'about-vision-text': 'To become Turkey\'s leading mold manufacturing company and have a say in international markets. To take a leading role in the sector by following technological developments.',
        'about-values-title': 'Our Values',
        'about-values-subtitle': 'Core values that form our working principles',
        'about-value-quality-title': 'Quality',
        'about-value-quality-text': 'We work to ensure the highest quality standards in every project.',
        'about-value-reliability-title': 'Reliability',
        'about-value-reliability-text': 'We establish long-term, reliable business partnerships with our customers.',
        'about-value-innovation-title': 'Innovation',
        'about-value-innovation-text': 'We focus on continuous improvement and producing innovative solutions.',
        'about-value-delivery-title': 'On-Time Delivery',
        'about-value-delivery-text': 'We pay attention to completing our projects within the specified timeframes.',
        'about-cta-title': 'Ready to Work with Us?',
        'about-cta-subtitle': 'We offer professional mold solutions for your projects. Contact us now!',
        'about-cta-button-1': 'Get Quote',
        'about-cta-button-2': 'Contact Us',
