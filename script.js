...
const translations = {
    tr: {
        ...
        'story-text-1': 'AY MOLD, 2003 yılında İstanbul\'da kurulduğumuz günden bu yana, kalıp üretimi sektöründe güvenilir çözüm ortağınız olmaktan gurur duyuyoruz.',
        'story-text-2': 'Kurulduğumuz ilk günlerden itibaren, müşteri memnuniyetini ön planda tutarak, en yüksek kalite standartlarında kalıp üretimi yapmaya odaklandık. Modern teknoloji ve uzman ekibimizle, sektörün öncü firmalarından biri haline geldik.',
    ...
    en: {
        ...
        'story-text-1': 'AY MOLD, since our establishment in Istanbul in 2003, we are proud to be your reliable solution partner in the mold manufacturing sector.',
        'story-text-2': 'From our first days, we focused on producing molds at the highest quality standards by prioritizing customer satisfaction. We have become one of the leading companies in the sector with modern technology and expert team.',
